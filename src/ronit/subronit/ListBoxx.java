...
public class ListBoxx extends Application
{
...
GridPane.setConstraints(technologies, 0, 0, 1, 1, HPos.CENTER, VPos.TOP, null, null, new Insets(20,0,0,20));
GridPane.setConstraints(btn, 0, 1, 1, 1, HPos.LEFT, VPos.TOP, null, null, new Insets(20,0,0,20));
GridPane.setConstraints(delBtn, 1, 1, 1, 1, HPos.LEFT, VPos.TOP, null, null, new Insets(20,0,0,20));
